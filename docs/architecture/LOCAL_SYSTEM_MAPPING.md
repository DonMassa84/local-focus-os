...
| Local status domain | `DokumentenSystem/11_STATUS_UND_STEUERUNG/workflow_automation` | status source |
| GitHub | `DonMassa84/local-focus-os` | sanitized code and documentation |
